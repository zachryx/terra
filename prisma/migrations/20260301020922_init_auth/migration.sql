...
*/
-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('ADMIN', 'ORGANIZER', 'SPONSOR', 'ATTENDEE');

-- CreateEnum
CREATE TYPE "SsoProvider" AS ENUM ('GOOGLE', 'FACEBOOK', 'LOCAL');
...
ADD COLUMN     "provider" "SsoProvider" NOT NULL DEFAULT 'LOCAL',
